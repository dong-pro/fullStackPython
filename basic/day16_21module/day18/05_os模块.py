...
# print(os.stat(r'E:\pythondemo\python\py_old_boy_15\pytrain_03_module\day18\05_os模块.py'))
...
# print('-->', os.getcwd())  # current work dir 当前工作目录:并不是指当前文件所在的目录,指的是当前文件是在哪个目录下执行的
