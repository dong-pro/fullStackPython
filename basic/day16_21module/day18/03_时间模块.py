...
# time模块主要是用来和时间打交道的
# 1534732642.617272  浮点型数据类型,以s为单位 时间戳时间 - 给机器计算用的  从1970 1 1 0:0:0开始
# 时间格式
# '2018-8-20' '2018.8.20' 字符串数据类型     格式化时间 - 给人看的
# 结构化时间
# time.struct_time(tm_year=2019, tm_mon=9, tm_mday=10, tm_hour=9, tm_min=45, tm_sec=6, tm_wday=1, tm_yday=253, tm_isdst=0)
...
# 字符串时间 转 时间戳
# struct_time = time.strptime('2019-9-8 11:11:11', '%Y-%m-%d %H:%M:%S')
# print(struct_time)
