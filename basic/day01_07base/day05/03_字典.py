...
# print(dic)
#
# dic = {'name': 'admin', 'age': 9000, '易大师': '剑圣', '剑豪': '亚索'}
# # 增
# dic['火女'] = '人头狗'  # 新增
# print(dic)
# dic.setdefault('火女', '安妮')  # 如果在字典中存在就不进行任何操作,不存在就进行添加
# dic.setdefault('hah', '火男')
# print(dic)
...
dic1 = {
    'name': ['admin', 2, 3, 5],
    'job': 'teacher',
    'lst': {'root': ['python1', 'python2', 100]}
}
# 1，将name对应的列表追加⼀个元素’test’。
# 2，将name对应的列表中的admin⾸字⺟⼤写。
# 3，lst对应的字典加⼀个键值对’mac’,’linux’。
# 4，将lst对应的字典中的root对应的列表中的python2删除

dic1['name'].append('test')
print(dic1)
dic1['name'][0] = dic1['name'][0].title()
print(dic1)
dic1['lst'].setdefault('mac', 'system')
print(dic1['lst'])
dic1['lst']['root'].pop(1)
print(dic1)