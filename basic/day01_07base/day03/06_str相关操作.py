s = 'code change the World! Just do it'
...
# s = 'sb libai dufu sb sb wangwei liqingzhao sb'
...
# print(s2)
#
# s = 'libai_dufu_wangwei_liqingzhao'
# s1 = s.replace('_', '')
# print(s1)

# s8 = 'libai_dufu_wangwei_liqingzhao'
# s9 = s8.replace('i', 'sb', 2)  # 换两次
# print(s9)
#
# lst = s8.split('qiege')  # 切完的结果是一个列表. 列表中装的是字符串. 用什么切. 就会损失掉什么
# print(lst)
